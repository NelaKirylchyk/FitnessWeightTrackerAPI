...
namespace FitnessWeightTrackerAPI.Migrations
{
    ...
    [Migration("20241114182538_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessWeightTrackerAPI.Models.MyIdentityUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessWeightTrackerAPI.Models.MyIdentityUserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessWeightTrackerAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2024, 11, 14, 18, 25, 38, 50, DateTimeKind.Utc).AddTicks(9820),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("FitnessWeightTrackerAPI.Models.MyIdentityUserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("FitnessWeightTrackerAPI.Models.MyIdentityUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
