...
namespace FitnessWeightTrackerAPI.Migrations
{
    ...
    [Migration("20250930180323_AddDomainIndexes")]
    partial class AddDomainIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessWeightTrackerAPI.Models.FitnessUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessWeightTrackerAPI.Models.FitnessUserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessWeightTrackerAPI.Models.FoodRecord", b =>
                {
                    ...
                    b.HasIndex("UserId", "ConsumptionDate");
            ...
            modelBuilder.Entity("FitnessWeightTrackerAPI.Models.BodyWeightRecord", b =>
                {
                    b.HasOne("FitnessWeightTrackerAPI.Models.FitnessUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("FitnessWeightTrackerAPI.Models.FitnessUserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("FitnessWeightTrackerAPI.Models.FitnessUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
